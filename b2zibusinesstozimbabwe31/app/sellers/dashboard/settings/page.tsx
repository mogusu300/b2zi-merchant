...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h1 className="text-3xl font-bold text-b2zi-black">Store Settings</h1>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-b2zi-dark"
            >
      ...
      <div className="flex justify-end">
        <Button onClick={handleSave} className="bg-b2zi-dark hover:bg-b2zi-black text-white">
